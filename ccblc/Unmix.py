...
def SVN(img):
    ...
    # run each unmixing iteration
    um_00 = img.unmix([soil["00"], pv["00"], npv["00"]], True, True)
    um_01 = img.unmix([soil["01"], pv["01"], npv["01"]], True, True)
    um_02 = img.unmix([soil["02"], pv["02"], npv["02"]], True, True)
    um_03 = img.unmix([soil["03"], pv["03"], npv["03"]], True, True)
    um_04 = img.unmix([soil["04"], pv["04"], npv["04"]], True, True)
    um_05 = img.unmix([soil["05"], pv["05"], npv["05"]], True, True)
    um_06 = img.unmix([soil["06"], pv["06"], npv["06"]], True, True)
    um_07 = img.unmix([soil["07"], pv["07"], npv["07"]], True, True)
    um_08 = img.unmix([soil["08"], pv["08"], npv["08"]], True, True)
    um_09 = img.unmix([soil["09"], pv["09"], npv["09"]], True, True)
    um_10 = img.unmix([soil["10"], pv["10"], npv["10"]], True, True)
    um_11 = img.unmix([soil["11"], pv["11"], npv["11"]], True, True)
    um_12 = img.unmix([soil["12"], pv["12"], npv["12"]], True, True)
    um_13 = img.unmix([soil["13"], pv["13"], npv["13"]], True, True)
    um_14 = img.unmix([soil["14"], pv["14"], npv["14"]], True, True)
    um_15 = img.unmix([soil["15"], pv["15"], npv["15"]], True, True)
    um_16 = img.unmix([soil["16"], pv["16"], npv["16"]], True, True)
    um_17 = img.unmix([soil["17"], pv["17"], npv["17"]], True, True)
    um_18 = img.unmix([soil["18"], pv["18"], npv["18"]], True, True)
    um_19 = img.unmix([soil["19"], pv["19"], npv["19"]], True, True)
    um_20 = img.unmix([soil["20"], pv["20"], npv["20"]], True, True)
    um_21 = img.unmix([soil["21"], pv["21"], npv["21"]], True, True)
    um_22 = img.unmix([soil["22"], pv["22"], npv["22"]], True, True)
    um_23 = img.unmix([soil["23"], pv["23"], npv["23"]], True, True)
    um_24 = img.unmix([soil["24"], pv["24"], npv["24"]], True, True)
    um_25 = img.unmix([soil["25"], pv["25"], npv["25"]], True, True)
    um_26 = img.unmix([soil["26"], pv["26"], npv["26"]], True, True)
    um_27 = img.unmix([soil["27"], pv["27"], npv["27"]], True, True)
    um_28 = img.unmix([soil["28"], pv["28"], npv["28"]], True, True)
    um_29 = img.unmix([soil["29"], pv["29"], npv["29"]], True, True)
...
def BVNS(img):
    ...
    # run each unmixing iteration
    um_00 = img.unmix([burn["00"], pv["00"], npv["00"], soil["00"]], True, True)
    um_01 = img.unmix([burn["01"], pv["01"], npv["01"], soil["01"]], True, True)
    um_02 = img.unmix([burn["02"], pv["02"], npv["02"], soil["02"]], True, True)
    um_03 = img.unmix([burn["03"], pv["03"], npv["03"], soil["03"]], True, True)
    um_04 = img.unmix([burn["04"], pv["04"], npv["04"], soil["04"]], True, True)
    um_05 = img.unmix([burn["05"], pv["05"], npv["05"], soil["05"]], True, True)
    um_06 = img.unmix([burn["06"], pv["06"], npv["06"], soil["06"]], True, True)
    um_07 = img.unmix([burn["07"], pv["07"], npv["07"], soil["07"]], True, True)
    um_08 = img.unmix([burn["08"], pv["08"], npv["08"], soil["08"]], True, True)
    um_09 = img.unmix([burn["09"], pv["09"], npv["09"], soil["09"]], True, True)
    um_10 = img.unmix([burn["10"], pv["10"], npv["10"], soil["10"]], True, True)
    um_11 = img.unmix([burn["11"], pv["11"], npv["11"], soil["11"]], True, True)
    um_12 = img.unmix([burn["12"], pv["12"], npv["12"], soil["12"]], True, True)
    um_13 = img.unmix([burn["13"], pv["13"], npv["13"], soil["13"]], True, True)
    um_14 = img.unmix([burn["14"], pv["14"], npv["14"], soil["14"]], True, True)
    um_15 = img.unmix([burn["15"], pv["15"], npv["15"], soil["15"]], True, True)
    um_16 = img.unmix([burn["16"], pv["16"], npv["16"], soil["16"]], True, True)
    um_17 = img.unmix([burn["17"], pv["17"], npv["17"], soil["17"]], True, True)
    um_18 = img.unmix([burn["18"], pv["18"], npv["18"], soil["18"]], True, True)
    um_19 = img.unmix([burn["19"], pv["19"], npv["19"], soil["19"]], True, True)
    um_20 = img.unmix([burn["20"], pv["20"], npv["20"], soil["20"]], True, True)
    um_21 = img.unmix([burn["21"], pv["21"], npv["21"], soil["21"]], True, True)
    um_22 = img.unmix([burn["22"], pv["22"], npv["22"], soil["22"]], True, True)
    um_23 = img.unmix([burn["23"], pv["23"], npv["23"], soil["23"]], True, True)
    um_24 = img.unmix([burn["24"], pv["24"], npv["24"], soil["24"]], True, True)
    um_25 = img.unmix([burn["25"], pv["25"], npv["25"], soil["25"]], True, True)
    um_26 = img.unmix([burn["26"], pv["26"], npv["26"], soil["26"]], True, True)
    um_27 = img.unmix([burn["27"], pv["27"], npv["27"], soil["27"]], True, True)
    um_28 = img.unmix([burn["28"], pv["28"], npv["28"], soil["28"]], True, True)
    um_29 = img.unmix([burn["29"], pv["29"], npv["29"], soil["29"]], True, True)
